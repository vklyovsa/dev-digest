...
export const NAV: NavGroup[] = [
  ...
  {
    // Everything that AUTHORS what an agent knows lives here: the agents
    // themselves, the skills they load, and the conventions a skill is built
    // from. Pull Requests is the only workspace surface — it is where the
    // authored thing gets used.
    section: "SKILLS LAB",
    items: [
