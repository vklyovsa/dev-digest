...
/** Skills linked to an agent, ordered — the Skills tab's current selection. */
...
/**
 * Replace an agent's whole ordered skill set. Attach, detach and reorder are
 * all the same call: the array IS the order, and the prompt renders the blocks
